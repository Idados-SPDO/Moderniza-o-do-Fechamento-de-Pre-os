...
def main():
    ...
    with st.sidebar:
        ...
        with st.expander("Modelo preenchimento"):
            ...
            modelo = pd.read_excel("data/Modelo_preenchimento_usuário.xlsx")
...
if __name__ == "__main__":
    ...
    names = ['Matheus Donato', "Diego Silva", "Camila Ceciliano"]
    usernames = ['mdonato', "dsilva", "cceciliano"]
    passwords = ['123', 'dados_fgv', 'dados_fgv']
